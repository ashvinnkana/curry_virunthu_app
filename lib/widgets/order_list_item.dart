...
class _OrderListItemState extends State<OrderListItem> {
  dynamic itemStateColor = {
    ...
    "BILLING": {"DONE": Color(0xff53a233), "REMOVED": Color(0xffea4e4e)},
    "PAID": {"DONE": Color(0xff3097c2), "REMOVED": Color(0xffea4e4e)},
    "NOT-PAID": {"DONE": Color(0xffea4e4e), "REMOVED": Color(0xffea4e4e)}
  };
                  ...
                  Padding(
                      ...
                      child: RichText(
                        text: new TextSpan(
                          style: new TextStyle(
                            fontSize: 13.0,
                            color: itemStateColor[widget.orderState]
                                [widget.state],
                          ),
                          children: <InlineSpan>[
