                                  ...
                                  try {
                                    ...
                                    await auth.verifyPhoneNumber(
                                      ...
                                      verificationFailed: (FirebaseAuthException e) {
                                        print("Phone ERROR: " + e.message.toString());
                                        status = true;
                                        setState(() {
                                          loading = false;
                                          _controller = new TextEditingController();
                                        ...
                                        showDialog<void>(
                                          ...
                                          builder: (BuildContext context) {
                                            return AlertDialog(
                                              title: const Text('Something Went Wrong'),
                                              content: const Text('Entered phone number is Invalid'),
                                              actions: <Widget>[
                                                TextButton(
                                                  style: TextButton.styleFrom(
                                                    textStyle: Theme.of(context).textTheme.labelLarge,
                                    ...
                                    final timer = Timer(
                                      const Duration(seconds: 5),
                                        ...
                                        if (ModalRoute.of(context)?.settings.name == null && status == false){
                                          setState(() {
                                            loading = false;
                                            _controller = new TextEditingController();
                                          });
                                          showDialog<void>(
                                            ...
                                            builder: (BuildContext context) {
                                              return AlertDialog(
                                                title: const Text('Something Went Wrong'),
                                                content: const Text('Entered phone number was attempted already, cannot send verification code immediately\n\nTRY AGAIN LATER'),
                                                actions: <Widget>[
                                                  TextButton(
                                                    style: TextButton.styleFrom(
                                                      textStyle: Theme.of(context).textTheme.labelLarge,
